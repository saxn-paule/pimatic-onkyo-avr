...
Onkyo.prototype.PwrOn = function(callback)
  {
    this.SendCommand("POWER", "STATUS", function(err, status) {
      if( !status.Power ) this.SendCommand('POWER', 'ON', callback);
...
Onkyo.prototype.PwrOff = function(callback)
  {
    this.SendCommand("POWER", "STATUS", function(err, status) {
      if( status.PWR ) this.SendCommand('POWER', 'OFF', callback);
      else if(callback)callback(null, status);
    });
  }
Onkyo.prototype.PwrState = function(callback)
  {
    this.SendCommand('POWER', "STATUS", callback);
  }
